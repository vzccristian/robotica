...
static const char qt_meta_stringdata_ejemplo1[] = {
    "ejemplo1\0\0doButtonStart()\0doButtonPause()\0"
    "doButtonSetPeriod()\0doButtonRestart()\0"
};
...
void ejemplo1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->doButtonStart(); break;
        case 1: _t->doButtonPause(); break;
        case 2: _t->doButtonSetPeriod(); break;
        case 3: _t->doButtonRestart(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *ejemplo1::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_ContadordeCristian"))
        return static_cast< Ui_ContadordeCristian*>(const_cast< ejemplo1*>(this));
